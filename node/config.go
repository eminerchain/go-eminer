...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of em is "em". If no
...
// These resources are resolved differently for "em" instances.
...
func (c *Config) resolvePath(path string) string {
	...
	// by em 1.4 are used if they exist.
	if c.name() == "em" && isOldGethResource[path] {
		oldpath := ""
		if c.Name == "em" {
