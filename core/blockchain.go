...
import (
	...
	"github.com/eminerchain/go-eminer/core/watch"
)
...
// Processor.
func NewBlockChain(chainDb emdb.Database, config *params.ChainConfig, dacEngine consensus.Engine, vmConfig vm.Config, itxDb emdb.Database) (*BlockChain, error) {
...
func (bc *BlockChain) InsertReceiptChain(blockChain types.Blocks, receiptChain []types.Receipts) (int, error) {
	...
	for i, block := range blockChain {
		...
		if batch.ValueSize() >= emdb.IdealBatchSize {
