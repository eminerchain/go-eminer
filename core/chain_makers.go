...
func GenerateChain(config *params.ChainConfig, parent *types.Block, dacEngine consensus.Engine, db emdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
// header only chain.
func newCanonical(dacEngine consensus.Engine, n int, full bool) (emdb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, dacEngine consensus.Engine, db emdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, dacEngine consensus.Engine, db emdb.Database, seed int) []*types.Block {
