...
import (
	...
	"github.com/eminerchain/go-eminer/util"
	"math/big"
	"strings"
)
...
func SetupGenesisBlock(db emdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, *Genesis, error) {
...
func (g *Genesis) Commit(db emdb.Database) (*types.Block, error) {
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db emdb.Database) *types.Block {
...
func GenesisBlockForTesting(db emdb.Database, addr common.Address, balance *big.Int) *types.Block {
