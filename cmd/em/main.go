...
import (
	...
	"github.com/eminerchain/go-eminer/emclient"
...
const (
	clientIdentifier = "em" // Client identifier to advertise over the network
)
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	go func() {
		...
		stateReader := emclient.NewClient(rpcClient)
